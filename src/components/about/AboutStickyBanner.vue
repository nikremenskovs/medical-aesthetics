...
<template>
  <div class="about-sticky__background relative h-full w-full">
    <img
      ...
      :src="aboutPageStore.banner.aboutBackground.image"
      :alt="aboutPageStore.banner.aboutBackground['image-alt']"
    />
    <div
    ...
    >
      <h1 class="mb-2 font-yeseva-one text-4xl uppercase">
        {{ aboutPageStore.banner.aboutTitle }}
      </h1>
      <span class="mx-auto mb-4 block h-1 w-1/4 bg-main-white" />
      <p class="font-marmelad text-lg">
        {{ aboutPageStore.banner.aboutSubtitle }}
      </p>
    </div>
    <div
